...
DOWNLOAD_ROOT = 'https://github.com/iterait/emloop-examples/releases/download/mnist-dataset/'
...
class MNISTDataset(el.DownloadableDataset):
            ...
            for key in FILENAMES:
                ...
                if not path.exists(file_path):
                    raise FileNotFoundError('File `{}` does not exist. '
                                            'Run `emloop dataset download <path-to-config>` first!'.format(file_path))
